...
function addToShoppingCart(itemGrocery) {
  shoppingCart.push(itemGrocery);
...
console.log(addToShoppingCart('food1'));
console.log(addToShoppingCart('food2'));
console.log(addToShoppingCart('food3'));

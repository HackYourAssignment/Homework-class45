...
function main() {
  const numKids = [2, 3, 1, 4, 7];

  const partnerNames = ['Lisa', 'John', 'Mike', 'Laura', 'Jane'];

  const locations = ['Athene', 'London', 'Amsterdam', 'Paris', 'Istanbul'];

  const jobTitles = ['teacher', 'doctor', 'dentist', 'lawyer', 'engineer'];

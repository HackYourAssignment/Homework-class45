...
// ! Function under test
function sanitizeFruitBasket(inFruit, fruitOut) {
  const sanitized = inFruit.filter((fruit) => fruit !== fruitOut);
  return sanitized;
}
const lemonsFree = sanitizeFruitBasket(fruitBasket, 'lemon');
console.log(lemonsFree);
...
describe('sanitizeFruitBasket', () => {
  ...
  test('should not modify the original `fruitBasket` array', () => {
    ...
    expect(originalFruitBasketContents).toBe(originalFruitBasketContents);
  });

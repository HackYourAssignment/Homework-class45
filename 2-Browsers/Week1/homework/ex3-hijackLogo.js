...
function hijackGoogleLogo() {
  // Find the Google logo element by its class name
  const googleLogo = document.getElementsByClassName('lnXdpd')[0];

  // Replace the src and srcset attributes with the HackYourFuture logo URL

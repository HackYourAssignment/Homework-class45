...
/*The problem no longer occurs - if the die rolled off the table, 
we're not getting the success message. It happens because Promises are 
catching the errors more efficiently and once there is an error, the code
immediately jumps to the catch block skipping any else blocks. */
